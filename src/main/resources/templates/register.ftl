                ...
                <div class="form-group">
                    <div class="form-row">
                        <div class="col-md-6">
                            ...
                            <input class="form-control" id="id_username" type="text" aria-describedby="nameHelp"
                                   placeholder="Enter Username" name="username">
                        </div>
                        <div class="col-md-6">
                            <label for="id_nickname">昵称</label>
                            <input class="form-control" id="id_nickname" type="text" aria-describedby="nameHelp"
                ...
                <div class="form-group">
                    <div class="form-row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input class="form-control" id="id_confirm_password" type="password"
